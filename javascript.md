...
![截图](b338a5391bf096bc832c154dd2c078cd.png)
...
<img src="072adf50e9743601540aaae8be6ff5fa.png" alt="截图" style="zoom:75%;" />
...
指向我们实例对象。原型对象里面放的是方法, 这个方法里面的this指向的是这个方法的调用者, 也就是这个实例对象
...
![截图](b120725efea9e7984bcf5766a508ca14.png)
...
![截图](482fddfd04f915aac40753718e6a533b.png)
